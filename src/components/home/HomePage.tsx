        ...
        <SortableContext items={dailies.map((d) => d.id)} strategy={rectSortingStrategy}>
          ...
          >
            ...
            <button
              ...
              className="min-h-32 flex items-center justify-center rounded-xl border-2 border-dashed border-slate-200 text-slate-300 hover:border-amber-400 hover:text-amber-500 transition-colors appearance-none bg-transparent cursor-pointer"
            >
